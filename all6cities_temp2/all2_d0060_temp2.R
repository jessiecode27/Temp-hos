...
# RUN THE MODEL
model <- glm(d_0060 ~ cb + dow + ns(time,df=39*4)+ ns(rh,df=3),
...
mfirst <- glm(d_0060 ~ cb+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(d_0060 ~ cb2+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(d_0060 ~ cb3+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(d_0060 ~ cb4+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(d_0060 ~ cb+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(d_0060 ~ cb2+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(d_0060 ~ cb3+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(d_0060 ~ cb4+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(d_0060 ~ cb+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(d_0060 ~ cb2+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(d_0060 ~ cb3+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(d_0060 ~ cb4+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(d_0060 ~ cb+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(d_0060 ~ cb2+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(d_0060 ~ cb3+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(d_0060 ~ cb4+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
