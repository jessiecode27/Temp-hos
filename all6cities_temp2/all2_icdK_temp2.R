...
# RUN THE MODEL
model <- glm(icd_K ~ cb + dow + ns(time,df=39*4)+ ns(rh,df=3),
...
mfirst <- glm(icd_K ~ cb+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(icd_K ~ cb2+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(icd_K ~ cb3+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(icd_K ~ cb4+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(icd_K ~ cb+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(icd_K ~ cb2+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(icd_K ~ cb3+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(icd_K ~ cb4+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(icd_K ~ cb+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(icd_K ~ cb2+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(icd_K ~ cb3+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(icd_K ~ cb4+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(icd_K ~ cb+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(icd_K ~ cb2+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(icd_K ~ cb3+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(icd_K ~ cb4+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
