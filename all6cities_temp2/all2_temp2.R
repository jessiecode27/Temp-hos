...
# RUN THE MODEL
model <- glm(hos2 ~ cb + dow + ns(time,df=39*4)+ ns(rh,df=3),
...
mfirst <- glm(hos2 ~ cb+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(hos2 ~ cb2+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(hos2 ~ cb3+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(hos2 ~ cb4+dow+ns(time,df=11*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(hos2 ~ cb+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(hos2 ~ cb2+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(hos2 ~ cb3+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(hos2 ~ cb4+dow+ns(time,df=6*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(hos2 ~ cb+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(hos2 ~ cb2+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(hos2 ~ cb3+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(hos2 ~ cb4+dow+ns(time,df=4*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
# RUN THE FIRST-STAGE MODELS
mfirst <- glm(hos2 ~ cb+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst2 <- glm(hos2 ~ cb2+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst3 <- glm(hos2 ~ cb3+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
mfirst4 <- glm(hos2 ~ cb4+dow+ns(time,df=8*4)+ ns(rh,df=3),family=quasipoisson(),sub)
...
plot(cpall,ylab="RR",col=2,lwd=2,ylim=c(.8,2),xlab="Temperature (C)",family = "Times New Roman")
...
legend ("top",c("B-spline of lag 0-21 (with 95%CI)","B-spline of lag 0-3",
                "B-spline of lag 0-7", "B-spline of lag 0-14"),lty=c(1,2,4,4),lwd=1.5,col=2:5,bty="n",inset=0.05,
